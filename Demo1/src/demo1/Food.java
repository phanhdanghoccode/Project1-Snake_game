...
public class Food {
    private int x; // Tọa độ X của food
    private int y; // Tọa độ Y của food
    ...
    public void reset() {
        x = (int) (Math.random() * 16) * 50; // Đặt lại vị trí của food theo grid (800/50 = 16 ô chiều ngang)
    ...
    private void loadRandomImage() {
        try {
            ...
            imageIcon = new ImageIcon(getClass().getResource(imageName)); // Đọc ảnh từ file
        } catch (Exception e) {
